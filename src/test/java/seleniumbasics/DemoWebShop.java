...
public class DemoWebShop {
    ...
    @Test
    public void TC_004_verifyDemoWebShopTitleHomeWork() throws IOException {
        String actualTitle = driver.getTitle();
    ...
    public void TC_005_verifyInvalidLogin(String userName, String pword){
    ...
    public void TC_007_verifyValidLoginHomework(String userName, String pword){
        WebElement login= driver.findElement(By.xpath("//a[@class='ico-login']"));
        login.click();
        WebElement email= driver.findElement(By.xpath("//input[@id='Email']"));
        email.sendKeys(userName);
